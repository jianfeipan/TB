	...
	implements org.omg.CORBA.portable.InvokeHandler, tpcorba.exo2.calculOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "soustraitMemoire", new java.lang.Integer(2));
		m_opsHash.put ( "decrementer", new java.lang.Integer(3));
		m_opsHash.put ( "multiplieMemoire", new java.lang.Integer(4));
		m_opsHash.put ( "_get_memoire", new java.lang.Integer(5));
		m_opsHash.put ( "diviseMemoire", new java.lang.Integer(6));
		m_opsHash.put ( "miseAZero", new java.lang.Integer(7));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // soustraitMemoire
			{
				double _arg0=_input.read_double();
				_out = handler.createReply();
				soustraitMemoire(_arg0);
				break;
			}
			case 3: // decrementer
			{
