 ...
 * @author M. L. Liu
 */
public class Example2SenderReceiver_name {
...
//    <message, a string, to send>
   ...
   public static void main(String[] args) {
      if (args.length != 4)
	    ...
	    Contact contact = new Contact(args[2]);
  	    InetAddress receiverHost = InetAddress.getByName(contact.host());
            int receiverPort = Integer.parseInt(contact.port());	
