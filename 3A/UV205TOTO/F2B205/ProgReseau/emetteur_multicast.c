...
int main(int argc, char **argv) {
  ...
  // Set local instance for multicast:
  local_interface.s_addr = inet_addr("10.29.230.196");
  if (setsockopt(s, IPPROTO_IP, IP_MULTICAST_IF, (char *)&local_interface, sizeof(local_interface)) < 0) {
